...
Front End: Chrome extension using Javascript

Back End: Java + Spring Boot
The extension will communicate to a Spring Boot REST API. The backend will receive the class information and process it.

Database (MySQL)
The backend will store the data in a MySQL database

Response Back to Front End
After processing class/assignment data, prioritized / organized lists will be returned to display on front end.
